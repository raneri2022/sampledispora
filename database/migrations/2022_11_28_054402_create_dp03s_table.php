...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('dp03s', function (Blueprint $table) {
            ...
            $table->string('dp03001');//gender_namecountry_place_of_origin_name
            $table->string('dp03002');//state/regione_place_of_origin_name
            $table->string('dp03003');//village/town_place_of_origin_name
